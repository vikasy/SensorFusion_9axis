...
# Use sys.path to add parent directory for QuatMath access
import sys
import os
...
# 6-axis noise parameters - Fully optimized (2025-10-15)
# R matrix components (measurement noise):
SF_6XAG_QVACC = 2e-6    # Accelerometer quantization noise (unchanged)
SF_6XAG_QWACC = 10.0    # Accelerometer white noise (optimized: was 1e-4, now 10.0 for R=10)
SF_6XAG_QVGYRO = 0.01   # Gyro quantization noise in radians (unchanged)
SF_6XAG_QWGYRO = 1e-9   # Gyro white noise in radians (unchanged)
# Q matrix parameters (process noise):
SF_6XAG_QOrient = 10.0      # Optimized via three-way comparison (was 0.1)
SF_6XAG_QBias = 10.0        # Tuned to 10.0 (was 100.0)
SF_6XAG_QLinAcc = 1.0       # Optimized via three-way comparison (was 10.0)
SF_6XAG_QBiasOrient = 0.1   # Verified optimal via three-way comparison
